...
const prizes = [
    {
        ...
        tag: 'CHAMPION',
        perks: [
            'Total Cash Pool — ₹17,000',
            'First Prize — ₹10,000',
            'Second Prize — ₹7,000',
            'VC Pitch Opportunity & Investor Access',
            'Potential seed-stage funding',
        ],
        cardBg: 'linear-gradient(160deg, #120303 0%, #2e0808 30%, #591010 55%, #8a1a1a 85%, #420a0a 100%)',
        shimmer: 'linear-gradient(135deg, rgba(255,100,100,0.2) 0%, transparent 60%)',
        borderColor: '#FF6347',
        glowColor: '#FF6347',
        glowRgba: 'rgba(255,99,71,0.9)',
        amountColor: '#FFCCCB',
        labelColor: '#ffd6cc',
        ribbonColor: '#3a0909',
        tagBg: 'rgba(0,0,0,0.5)',
        sparkBg: 'rgba(255,99,71,0.12)',
    },
    {
        id: 1,
        trophyEl: <TrophyGold size={85} />,
        label: 'FIRST PRIZE',
        amount: '₹10,000',
        sub: "Winner's Crown",
        tag: 'WINNER',
    ...
    },
    {
        ...
        cardBg: 'linear-gradient(160deg, #001217 0%, #002c38 30%, #005973 55%, #009eb3 85%, #004d5c 100%)',
        shimmer: 'linear-gradient(135deg, rgba(0,229,255,0.2) 0%, transparent 60%)',
        borderColor: '#00E5FF',
        glowColor: '#00E5FF',
        glowRgba: 'rgba(0,229,255,0.9)',
        amountColor: '#E0FFFF',
        labelColor: '#b3ffff',
        ribbonColor: '#002633',
        tagBg: 'rgba(0,0,0,0.5)',
        sparkBg: 'rgba(0,229,255,0.12)',
    }
];
...
const PrizeCard = ({ prize, relIdx, onClick, isMobile }) => {
    ...
    // Adjust horizontal spacing for mobile
    const xOffset = isMobile ? relIdx * 180 : relIdx * 290;

    return (
        <motion.div
            onClick={onClick}
            animate={{
                scale: p.scale, x: xOffset,
        ...
        >
            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 14 }}>
                    ...
                    <span style={{ color: '#FFD700', fontSize: 22, filter: 'drop-shadow(0 0 8px #FFD700)', textTransform: 'uppercase', fontWeight: 900, letterSpacing: '0.1em' }}>Rewards</span>
